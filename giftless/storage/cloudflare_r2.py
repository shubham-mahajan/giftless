...
class CloudflareR2Storage(StreamingStorage, ExternalStorage):
    """CloudFlare R2 Blob Storage backend.
    """

    def __init__(self, bucket_name: str, path_prefix: Optional[str] = None, endpoint: Optional[str] = None,
                access_id: Optional[str] = None, access_key: Optional[str] = None, **_):
        self.bucket_name = bucket_name
        self.path_prefix = path_prefix
        self.s3 = boto3.resource('s3', endpoint_url=endpoint, aws_access_key_id=access_id, aws_secret_access_key=access_key, config=Config(signature_version='s3v4'))
        self.s3_client = boto3.client('s3', endpoint_url=endpoint, aws_access_key_id=access_id, aws_secret_access_key=access_key, config=Config(signature_version='s3v4'))
